package sf.gs.slideunlocklib.renderers;
...
import sf.gs.slideunlocklib.IRenderer;
import sf.gs.slideunlocklib.ISlidingData;
...
public class ScaleRenderer implements IRenderer {
    ...
    @Override
    public int onSlideDone(ISlidingData slidingData, final View child) {
        child.animate()
                .alpha(0)
                .translationX(100)
